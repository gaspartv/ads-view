    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="relative overflow-hidden border-b border-border/50 bg-background/50 backdrop-blur-xl">
        ...
        <div className="container mx-auto py-12 px-4 md:px-8 relative z-10">
          ...
          <p className="text-muted-foreground mt-3 max-w-2xl text-lg">
            Bem-vindo ao dashboard administrativo. Aqui você tem controle total sobre os módulos da aplicação.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto py-10 px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Card de Categorias */}
          <Link href="/admin/dashboard/category" className="group outline-none">
            <Card className="relative overflow-hidden h-full border border-border/50 bg-card/40 backdrop-blur-sm transition-all duration-300 hover:shadow-2xl hover:shadow-primary/5 hover:border-primary/20 hover:-translate-y-1">
              ...
              <CardHeader className="pb-4">
                ...
                <CardDescription className="text-sm mt-2 leading-relaxed">
                  Gerencie todas as categorias de produtos, faça o upload de imagens, edite detalhes e altere os status visuais.
                </CardDescription>
              </CardHeader>
            </Card>
          </Link>
          ...
          {/* Card de Produtos */}
          <Link href="/admin/dashboard/product" className="group outline-none">
            <Card className="relative overflow-hidden h-full border border-border/50 bg-card/40 backdrop-blur-sm transition-all duration-300 hover:shadow-2xl hover:shadow-primary/5 hover:border-primary/20 hover:-translate-y-1">
              {/* Gradiente de hover interno */}
              <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              ...
              <CardHeader className="pb-4">
                ...
                <CardDescription className="text-sm mt-2 leading-relaxed">
                  Gerencie todo o seu catálogo de produtos, ajuste preços, controle o estoque e associe-os a categorias.
                </CardDescription>
              </CardHeader>
            </Card>
          </Link>
