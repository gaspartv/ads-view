...
export async function createCharacter(formData: FormData) {
  try {
    ...
    const dataToSend = {
      ...
      magicLevelExtra: payload.magicLevelExtra ? Number(payload.magicLevelExtra) : undefined,
      fistFighting: payload.fistFighting ? Number(payload.fistFighting) : undefined,
      fistFightingExtra: payload.fistFightingExtra ? Number(payload.fistFightingExtra) : undefined,
      swordFighting: payload.swordFighting ? Number(payload.swordFighting) : undefined,
      swordFightingExtra: payload.swordFightingExtra ? Number(payload.swordFightingExtra) : undefined,
      axeFighting: payload.axeFighting ? Number(payload.axeFighting) : undefined,
      axeFightingExtra: payload.axeFightingExtra ? Number(payload.axeFightingExtra) : undefined,
      clubFighting: payload.clubFighting ? Number(payload.clubFighting) : undefined,
      clubFightingExtra: payload.clubFightingExtra ? Number(payload.clubFightingExtra) : undefined,
      distanceFighting: payload.distanceFighting ? Number(payload.distanceFighting) : undefined,
      distanceFightingExtra: payload.distanceFightingExtra ? Number(payload.distanceFightingExtra) : undefined,
      shielding: payload.shielding ? Number(payload.shielding) : undefined,
      shieldingExtra: payload.shieldingExtra ? Number(payload.shieldingExtra) : undefined,
      fishing: payload.fishing ? Number(payload.fishing) : undefined,
      fishingExtra: payload.fishingExtra ? Number(payload.fishingExtra) : undefined,
